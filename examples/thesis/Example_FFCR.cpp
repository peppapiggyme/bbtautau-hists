...
void thesis_ffcr(const std::string& filename)
{
    ...
    for (VariableInfo* v : *(vs->content()))
    {
        ...
        ps->add("ttbarTF",    "t#bar{t} TF",        eProcessType::BKG,      eProcess::P2,           "Fake-#tau_{had} t#bar{t}",         bbtt_kORANGE);
        ps->add("ttbarFT",    "t#bar{t} FT",        eProcessType::BKG,      eProcess::P2,           "Fake-#tau_{had} t#bar{t}",         bbtt_kORANGE);
        ps->add("ttbarFF",    "t#bar{t} FF",        eProcessType::BKG,      eProcess::P2,           "Fake-#tau_{had} t#bar{t}",         bbtt_kORANGE);
